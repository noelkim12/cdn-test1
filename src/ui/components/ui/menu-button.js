...
// 커스텀 엘리먼트 등록
if (!customElements.get(`menu-button-${PLUGIN_NAME}`)) {
  customElements.define(`menu-button-${PLUGIN_NAME}`, MenuButton);
}

export const MENU_BUTTON_TAG = `menu-button-${PLUGIN_NAME}`;
