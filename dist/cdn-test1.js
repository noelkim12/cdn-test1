//@name cdn-test1
//@display-name cdn-test1_v0.6.5
//@version 0.6.5
//@description Cdn Test1 for RISU AI
//@arg test123 string
//@arg watchTest21 int
//@link https://unpkg.com/cdn-test1@0.6.5/dist/cdn-test1.js
var cdnTest1;
/******/ (() => { // webpackBootstrap
/******/ 	"use strict";
...
class AlertDialog extends HTMLElement {
  ...
  render() {
    ...
    this.innerHTML = `
      <div class="${styles_update_dialog_module.udCard} ${styles_update_dialog_module.udAlert}">
  ...
  attachEventListeners() {
    const card = this.querySelector(`.${styles_update_dialog_module.udCard}`);
    ...
    // 확인 버튼 클릭
    const confirmBtn = card.querySelector(`.${styles_update_dialog_module.udBtnPrimary}`);
    if (confirmBtn) {
